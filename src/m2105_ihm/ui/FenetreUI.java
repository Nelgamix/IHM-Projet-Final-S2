...
public class FenetreUI extends JFrame {
    ...
    private JMenu initMenuContacts() {
        ...
        menuContacts[0] = new JMenuItem("Nouveau Contact");
        ...
        menuContacts[1] = new JMenuItem("Nouveau Groupe");
        ...
        menuContacts[2] = new JMenuItem("Supprimer un contact");
        ...
        menuContacts[3] = new JMenuItem("Supprimer un groupe");
        ...
        menu.add(menuContacts[3]);
            ...
            menuContacts[4] = new JMenuItem("Ajouter contact groupe");
        ...
        menu.add(menuContacts[4]);
            ...
            menuContacts[5] = new JMenuItem("Retirer contact groupe");
    ...
    private JMenu initMenuEvenements() {
        ...
        menuEvenements[0] = new JMenuItem("Nouvel Evenement");
